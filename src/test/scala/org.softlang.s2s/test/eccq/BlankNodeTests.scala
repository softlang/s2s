...
class BlankNodeTests extends ValidationSuite("e_blank_"):
  ...
  //
  //
  // Another problem: This is not valid, right? This should be avoided?!
  ...
  //
  // # PHASE 1
  // - [x] Add test whether contained to G-CORE to SPARQL mapping
  // - [x] Add blank nodes (variable variant) to SPARQL
  // - [x] Generate actual blank nodes in SPARQL pretty printer (for Python)
  //       - Test, whether the semantics actually works out in Python
  //
  // PHASE 2
  // - [x] Adapt algorithm: Problably simple variable-concept treatment
  //          - Seems to work out of the box?
  // - [ ] Validate again with Python
  //          - TODO Needs proper G-CORE generator!!
  //
  //
  //
