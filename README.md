...
3. Run an example, using the included launcher script:
    ...
    * Windows: `.\bin\s2s.bat .\tutorial\examples\q1.sparql .\tutorial\examples\S1.shacl`
...
./s2s tutorial/examples/q1.sparql tutorial/examples/S1.shacl
```
