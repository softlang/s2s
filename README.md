...
The test suite can be executed via SBT (`sbt test`).
...
The remaining tools can be invoked via `runMain` and configured via their main methods; to this end, see [main](src/main/scala/org.softlang.s2s/main).
...
Another paper on extensions to this algorithm for [G-CORE](https://doi.org/10.1145/3183713.3190654)
